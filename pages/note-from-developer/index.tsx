  ...
  return (
    <Layout className={styles.Note}>
      <div>
        ...
        This website was built by me as an assignment, but that's not it. I have
        put a lot of time and effort making this website stand out.
        <br />
        So, I request you to send me your feedback (Contact details below). Even
        if you didn't like it, please let me know why. I would love to improve.
        <br />
        <br />
        Regards
        <br />
